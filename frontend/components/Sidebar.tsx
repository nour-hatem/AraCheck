...
export function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed md:static top-0 right-0 z-40 h-full bg-slate-900 text-slate-100 border-l border-slate-800 flex flex-col transition-all duration-300 ease-in-out shadow-2xl md:shadow-none ${
      ...
      >
        ...
        <div className="p-4 border-b border-slate-800 flex items-center justify-between gap-2 shrink-0">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-teal-500 to-emerald-400 text-slate-950 flex items-center justify-center font-bold">
              <Stethoscope className="w-4 h-4 stroke-[2.5]" />
            </div>
            <div>
              <h2 className="font-bold text-sm text-slate-100">المحادثات الطبية</h2>
              <p className="text-[10px] text-slate-400">سجل الاستفسارات السابقة</p>
            </div>
          </div>
          ...
          <Button
            ...
            size="icon"
            onClick={onToggle}
            className="w-8 h-8 rounded-lg text-slate-400 hover:text-slate-100 hover:bg-slate-800 transition-colors"
        ...
        <div className="p-3 shrink-0">
          <Button
            onClick={onNewChat}
            className="w-full bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-500 hover:to-emerald-500 text-white font-medium text-xs py-2.5 rounded-xl shadow-md shadow-teal-600/20 flex items-center justify-center gap-2 transition-all cursor-pointer"
          >
              ...
              return (
                <div
                  ...
                  className={`group relative flex items-center justify-between p-2.5 rounded-xl text-xs transition-all cursor-pointer ${
                    isActive
                      ? "bg-slate-800 text-teal-300 font-semibold border border-slate-700/80 shadow-xs"
                    ...
                    {isEditing ? (
                      ...
                      >
                        <input
                          ...
                          autoFocus
                          className="w-full bg-slate-950 text-white px-2 py-1 rounded text-xs border border-teal-500 focus:outline-hidden"
                        />
                        <button
                          type="submit"
        ...
        <div className="p-3 border-t border-slate-800 shrink-0">
          <button
            ...
            className="w-full flex items-center justify-between p-2 rounded-xl hover:bg-slate-800 transition-colors text-right cursor-pointer"
          >
